...
export class ContactComponent {
  email = 'patrickn.ss@outlook.com';
  
  contactMethods = [
    {
      name: 'Email',
      value: 'patrickn.ss@outlook.com',
      url: 'mailto:patrickn.ss@outlook.com',
      ...
      description: 'A melhor forma de me contactar'
    },
    {
      name: 'LinkedIn',
      value: '/in/trickn',
      url: 'https://www.linkedin.com/in/trickn/',
    ...
    },
    {
      name: 'GitHub',
      value: '@patricknss',
      url: 'https://github.com/patricknss',
